package com.erze.yqj.moudle.chat.ui;
 ...
 *
 */
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener,PopupMenu.OnMenuItemClickListener {
    ...
    protected String toChatUsername,nickName,avatar;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
      ...
      //  user.setAvatar();
     // EaseUser user = EaseUserUtils.getUserInfo(fragmentArgs.getString("hxid"));
       /* View inflate = LayoutInflater.from(getActivity()).inflate(R.layout.ease_row_sent_message, null);
         ImageView imageView = (ImageView) inflate.findViewById(R.id.iv_userhead);
        Glide.with(getActivity()).load(fragmentArgs.getString("avatar")).asBitmap().into(imageView);*/
...
//        messageList.setAvatarShape(1);
    ...
    private void initMenu(View view) {
        PopupMenu popup = new PopupMenu(getActivity(),titleBar,Gravity.RIGHT);
        MenuInflater inflater = popup.getMenuInflater();
        inflater.inflate(R.menu.more6, popup.getMenu());
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onUserAvatarClick(String username) {
                ...
                try {
                    String id = conversation.getLatestMessageFromOthers().getStringAttribute("id");
                    Intent intent = new Intent(getActivity(), OtherFollowActivity.class);
                    intent.setAction(id);
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        ...
        if (i == R.id.delete_item) {
            emptyHistory();
            return true;
        } else if (i == R.id.report_item) {
            Toast.makeText(getContext(), "举报按钮被点击", Toast.LENGTH_SHORT).show();
            return true;
        } else {
            return false;
        }
    ...
    protected void sendMessage(EMMessage message){
        ...
        message.setAttribute("id", sp.getString("userid",""));
        message.setAttribute("nickname", sp.getString("username",""));
        message.setAttribute("avatarURLPath", sp.getString("useravatar",""));
    ...
    public void resendMessage(EMMessage message){
        ...
        //send message
        SharedPreferences sp = getActivity().getSharedPreferences("user", Context.MODE_PRIVATE);
        message.setAttribute("id", sp.getString("userhxid",""));
        message.setAttribute("nickname", sp.getString("username",""));
        message.setAttribute("avatarURLPath", sp.getString("useravatar",""));
        EMClient.getInstance().chatManager().sendMessage(message);
        messageList.refresh();
