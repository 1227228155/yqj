...
import com.erze.yqj.moudle.voice.Voice2Activity;
...
public class PopupMenuUtil {
    ...
    public static PopupMenuUtil INSTANCE=null;
    ...
    //    rlClick = (RelativeLayout) rootVew.findViewById(R.id.pop_rl_click);
        ...
        ivBtn.setOnClickListener(new MViewClick(101, context));
    ...
    private class MViewClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (index == 101) {
                ...
                switch (index){
                    case 1:
                        context.startActivity(new Intent(context.getApplicationContext(),Voice2Activity.class));
                        break;
                    case 2:
                        RecordActivity.startActivity(context,
                        ...
                        break;
                    case 3:
                        FileImportActivity.startActivity(context);
                        break;
                }
            }
        }
