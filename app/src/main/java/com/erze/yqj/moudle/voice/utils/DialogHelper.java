...
//    }
    ...
    public DialogHelper(Context context, AsyncTask task) {
        ...
        prDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        TextView t = (TextView) prDialog.findViewById(com.erze.yqj.R.id.text);
        //设置对话框描述文字为接口的语言配置
        t.setText("请稍候");
    ...
    public DialogHelper(Context context, AsyncTask task,int max) {
        ...
        //设置对话框描述文字为接口的语言配置
        t.setText("请稍候");
        progress = (ProgressBar) prDialog.findViewById(com.erze.yqj.R.id.progress);
...
//        });
        ...
        progress = (ProgressBar) prDialog.findViewById(com.erze.yqj.R.id.progress1);
