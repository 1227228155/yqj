package com.erze.yqj.moudle.world.world.adapter;
...
public class TabWorldAdapter extends RecyclerView.Adapter<TabWorldAdapter.ViewHolder> {
    Context context;
    List<Videobean.ResultBean>  video_list ;//recyclerView数据集合
    ...
    public TabWorldAdapter(Context context, List<Videobean.ResultBean>  video_list,Window window,View view) {
    ...
    private void setOnPopupWindowListener(final int positon1) {
        ...
        pp_btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Videobean.ResultBean resultBean = video_list.get(positon1);
                intent.putExtra("video_url",  resultBean.getVideo_url());
                intent.putExtra("pic_url",  resultBean.getVideo_img());
                intent.putExtra("title",  resultBean.getVideo_description());
                intent.putExtra("video_id",  resultBean.getVideo_id());
