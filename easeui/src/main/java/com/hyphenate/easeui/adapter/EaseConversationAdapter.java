    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        /*    EaseUserUtils.setUserAvatar(getContext(), username, holder.avatar);
            ...
            if (conversation.getLatestMessageFromOthers()!=null){
                Glide.with(mContext).load(conversation.getLatestMessageFromOthers().getStringAttribute("avatarURLPath","")).into(holder.avatar);
                holder.name.setText(conversation.getLatestMessageFromOthers().getStringAttribute("nickname",""));
            }else {
                holder.avatar.setImageResource(R.drawable.null_avatar);
