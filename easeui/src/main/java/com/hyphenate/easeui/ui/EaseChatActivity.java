...
/**
 * you can new an EaseChatActivity to use or you can inherit it to expand.
 ...
 *
 */
public class EaseChatActivity extends BaseChatActivity implements EMMessageListener {
    protected static final String TAG = "EaseChatActivity";
    ...
    protected String toChatUsername,username;
    ...
    protected int[] itemdrawables = { R.drawable.p1, R.drawable.p2,
            R.drawable.p3 };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toChatUsername = getIntent().getStringExtra("hxid");
        initView();
        setUpView();
    }
    ...
    public void initView() {
        ...
        if(chatType != EaseConstant.CHATTYPE_SINGLE)
            messageList.setShowUserNick(true);//是否显示用户昵称
//        messageList.setAvatarShape(1);
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onResendClick(final EMMessage message) {
                new EaseAlertDialog(getApplicationContext(), R.string.resend, R.string.confirm_resend, null, new AlertDialogUser() {
                    @Override
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (listView.getFirstVisiblePosition() == 0 && !isloading && haveMoreData) {
                            ...
                            Toast.makeText(getApplicationContext(), getResources().getString(R.string.no_more_messages),
        ...
        if (resultCode == Activity.RESULT_OK) { 
            if (requestCode == REQUEST_CODE_CAMERA) { // capture new image
                ...
                if (locationAddress != null && !locationAddress.equals("")) {
                    ...
                    Toast.makeText(getApplicationContext(), R.string.unable_to_get_loaction, Toast.LENGTH_SHORT).show();
                }
    ...
    class MyItemClickListener implements EaseChatExtendMenu.EaseChatExtendMenuItemClickListener{
        ...
        public void onClick(int itemId, View view) {
            ...
            case ITEM_PICTURE:
                ...
                break;
            case ITEM_LOCATION:
                startActivityForResult(new Intent(EaseChatActivity.this, EaseBaiduMapActivity.class), REQUEST_CODE_MAP);
                break;
    ...
    protected void selectPicFromCamera() {
       ...
       /* cameraFile = new File(PathUtil.getInstance().getImagePath(), EMClient.getInstance().getCurrentUser()
        ...
        cameraFile = new File(Environment.getExternalStorageDirectory(), "/hx/"+EMClient.getInstance().getCurrentUser() + System.currentTimeMillis() + ".jpg");
    ...
    class GroupListener extends EaseGroupListener {
          ...
          runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (toChatUsername.equals(groupId)) {
                        Toast.makeText(getApplicationContext(), R.string.you_are_group, Toast.LENGTH_LONG).show();
                        Activity activity = EaseChatActivity.this;
        ...
        public void onGroupDestroyed(final String groupId, String groupName) {
           ...
           runOnUiThread(new Runnable() {
                public void run() {
                    if (toChatUsername.equals(groupId)) {
                        Toast.makeText(getApplicationContext(), R.string.the_current_group_destroyed, Toast.LENGTH_LONG).show();
                        Activity activity = EaseChatActivity.this;
                        if (activity != null && !activity.isFinishing()) {
                            activity.finish();
                        }
    ...
    class ChatRoomListener extends EaseChatRoomListener {
        ...
        public void onChatRoomDestroyed(final String roomId, final String roomName) {
           runOnUiThread(new Runnable() {
                public void run() {
                    if (roomId.equals(toChatUsername)) {
                        Toast.makeText(getApplicationContext(), R.string.the_current_chat_room_destroyed, Toast.LENGTH_LONG).show();
                        Activity activity = EaseChatActivity.this;
                        if (activity != null && !activity.isFinishing()) {
                            activity.finish();
                        }
        ...
        public void onRemovedFromChatRoom(final String roomId, final String roomName, final String participant) {
           runOnUiThread(new Runnable() {
                public void run() {
                    if (roomId.equals(toChatUsername)) {
                        Toast.makeText(getApplicationContext(), R.string.quiting_the_chat_room, Toast.LENGTH_LONG).show();
                        Activity activity = EaseChatActivity.this;
                        if (activity != null && !activity.isFinishing()) {
                            activity.finish();
                        }
        ...
        public void onMemberJoined(final String roomId, final String participant) {
            if (roomId.equals(toChatUsername)) {
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(getApplicationContext(), "member join:" + participant, Toast.LENGTH_LONG).show();
                    }
                });
            }
        }
        ...
        public void onMemberExited(final String roomId, final String roomName, final String participant) {
            if (roomId.equals(toChatUsername)) {
               runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(getApplicationContext(), "member exit:" + participant, Toast.LENGTH_LONG).show();
                    }
                });
            }
        }
    ...
    protected EaseChatActivityHelper chatFragmentHelper;
    public void setChatFragmentHelper(EaseChatActivityHelper chatFragmentHelper){
        this.chatFragmentHelper = chatFragmentHelper;
    }
    
    public interface EaseChatActivityHelper{
        /**
