...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
             ...
             avatar= sp.getString("useravatar", null);
            Glide.with(context).load(avatar).into(userAvatarView);
        }else{
            Glide.with(context).load(message.getStringAttribute("avatarURLPath","")).into(userAvatarView);
        }
